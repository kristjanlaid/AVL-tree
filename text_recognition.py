...
list_of_action_type_find = ['find','seek']
list_of_action_type_clean = ['clean','clear']
list_of_action_types = [list_of_action_type_create,
                        list_of_action_type_delete,
                        list_of_action_type_start,
                        list_of_action_type_find,
                        list_of_action_type_clean]

list_of_action_types_cases = ['create','delete','start','find','clean']
...
list_of_specification_uppest = ['uppest','biggest','largest','highest']
...
#sentence = 'Add 5 nodes superior to 5 and 2 inferior to 10'
...
#sentence = 'Add 5 nodes and a root of 42.'
...
#sentence = 'Delete 10'
#sentence = 'Delete 3 42.'
#sentence = 'Delete 3 and 42.'
#sentence = 'find 2 nodes inferior to 2.'
#sentence = 'find 2 inferior to 2.'
#sentence = 'Add 10 12 14.'
#sentence = 'Add 10, 12, 14.'
#sentence = 'Add the nodes 10, 12, 14.'
#sentence = 'Add 10 and 12'
#sentence = 'Delete the 5 lowest nodes and add 2 nodes.'
#sentence = 'Add 1 superior to 2 and 3 inferior to 4.'
#sentence = 'Add 2 nodes lower than the uppest value.'
sentence = 'Add 2 nodes, clean the graph and add 3 nodes.'
    ...
    for index_element in range(1,len(list_of_translated_sentence)):
        ...
        if (type(new_element) == Action):
            ...
            if (new_element.name == 'root'):
                buffer_range = 0
                if len(partitionized_translated_sentence)>1:#I conside the key word root like an action
                    list_of_partitionized_translated_sentence.append(partitionized_translated_sentence)
                partitionized_translated_sentence = [new_element]
            else:
